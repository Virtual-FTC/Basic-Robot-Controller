...
public class DcMotorOutput extends Message {
     ...
     */
    public static final String FIELD_ENCODER_DATA = "encoder_data";

    /**
     * The message type.
     */
    public static final String TYPE = "ftc_msgs/DcMotorOutput";
     ...
     */
    public static DcMotorOutput fromJsonString(String jsonString) {
