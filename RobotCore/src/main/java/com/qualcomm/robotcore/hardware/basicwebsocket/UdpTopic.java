 ...
 */
public class UdpTopic {

    private final RosUDP ros;
     ...
     */
    public UdpTopic(RosUDP ros, String name, String type) {
     ...
     */
    public UdpTopic(RosUDP ros, String name, String type, int throttleRate) {
